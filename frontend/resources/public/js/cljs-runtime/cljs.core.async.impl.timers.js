...
var i_14873 = (self__.level + (1));
while(true){
if((i_14873 <= (new_level + (1)))){
(update[i_14873] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14876 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14876[i]));
} else {
x__$2.forward.push((((i < links_14876.length))?(links_14876[i]):null));
}

if((i < links_14876.length)){
(links_14876[i] = x__$2);
} else {
links_14876.push(x__$2);
}
...
var i_14887 = (0);
while(true){
if((i_14887 <= self__.level)){
var links_14889 = (update[i_14887]).forward;
if((x__$1 === (((i_14887 < links_14889.length))?(links_14889[i_14887]):null))){
(links_14889[i_14887] = (x__$1.forward[i_14887]));

var G__14891 = (i_14887 + (1));
i_14887 = G__14891;
continue;
} else {
var G__14892 = (i_14887 + (1));
i_14887 = G__14892;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__14916 = nx;
var G__14917 = (level__$1 - (1));
x = G__14916;
level__$1 = G__14917;
continue;
} else {
var G__14918 = x;
var G__14919 = (level__$1 - (1));
x = G__14918;
level__$1 = G__14919;
continue;
}
