...
var G__12629 = request;
var G__12630 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12629,G__12630) : ajax.formats.get_format.call(null,G__12629,G__12630));
} else {
...
return cljs.core.some((function (p1__12665_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12665_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12689){
var map__12690 = p__12689;
var map__12690__$1 = cljs.core.__destructure_map(map__12690);
var request = map__12690__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12690__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12696 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12696.cljs$core$IFn$_invoke$arity$1 ? fexpr__12696.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12696.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12698){
var map__12699 = p__12698;
var map__12699__$1 = cljs.core.__destructure_map(map__12699);
var request = map__12699__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12699__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12697_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12697_SHARP_);
